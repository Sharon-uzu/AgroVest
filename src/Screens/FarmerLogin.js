...
const FarmerLogin = ({ setLoggedIn, setUserDetails }) => {
                    ...
                    <div className='sign'>
                        <form className='form'>
                            <div className="form-c">
                                ...
                                <span>As a farmer? <Link to="/farmerSignup">Sign Up</Link></span>
                                <span>As a user? <Link to="/farmerSignup">Sign Up</Link></span>
                            </div>
                        </form>
                    </div>
                </div>
